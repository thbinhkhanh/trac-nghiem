            ...
            <Stack spacing={2}>
              {currentQuestion.displayOrder.map((optIdx) => {
                ...
                return (
                  <Paper
                    key={optIdx}
                    onClick={handleSelect} // ✅ bấm cả Paper cũng chọn
                    sx={{
                      display: "flex",
                      alignItems: "center",
                      borderRadius: 1,
                      cursor: submitted || !started ? "default" : "pointer", // hiển thị con trỏ
                      bgcolor:
                  ...
                  >
                    <Radio
                      checked={selected}
                      onChange={handleSelect} // ✅ đồng bộ với Radio
                      sx={{ mr: 1 }}
                    />
                    <Typography
                      variant="body1"
                      sx={{ userSelect: "none" }} // tránh bôi đen khi click
                    >
                      {currentQuestion.options[optIdx]}
                    </Typography>
                  </Paper>
            ...
            <Stack spacing={2}>
              {currentQuestion.displayOrder.map((optIdx) => {
                ...
                return (
                  <Paper
                    key={optIdx}
                    onClick={handleSelect} // ✅ click Paper là chọn/bỏ chọn
                    sx={{
                      display: "flex",
                      alignItems: "center",
                      borderRadius: 1,
                  ...
                  >
                    <Checkbox
                      checked={checked}
                      onChange={handleSelect} // ✅ checkbox và Paper đều chung function
                      sx={{ mr: 1 }}
                    />
